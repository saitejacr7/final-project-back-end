...
import com.javacloud.bookmydoctor.service.PatientService;
...
public class PatientController {
	...
	@PostMapping(path = "/add-patient/{id}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public PatientResponse addPatient(@RequestBody Patient patient, @PathVariable("id") int id) {
		PatientResponse response = new PatientResponse();

		if (service.addPatient(patient, id)) {
